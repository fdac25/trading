...
Update 3: November 6th. Added Forbes scraper that gets critical article aspects. Article finder must be modified to get all articles from Forbes on Nvidia, and a Finder/Scraper run on all available articles is planned.
